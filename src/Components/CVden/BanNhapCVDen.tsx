...
export default function BanNhapCVDen(): ReactElement {
    ...
    useEffect(() => {
        (async () => {
            const response = await draftCVDen.get(manv);
    ...
    const handleClickDelete = async () => {
        const response = await draftCVDen.delete(iddraft);
    ...
    return (
        <div>
            <h2 style={{ textAlign: "center" }}>Bản nháp tiếp nhận</h2>
            <TableContainer
                component={Paper}
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        ...
                        <br /> Thao tác này sẽ không thể hoàn tác và dữ liệu sẽ
                        biến mất!
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
